...
if __name__ == "__main__":
    ...
    path_voc_test = "/Users/julien/code/deep_learning/VOC2007/"
    # model name of the weights
    model_name = "model_image_zooms"
    # path of folder where the weights are
    weights_path = "/Users/julien/code/deep_learning/models_image_zooms/"
    # path of where to store visualizations of search sequences
    path_testing_folder = '/Users/julien/code/deep_learning/testing/'
